...
parser.add_argument("--maas-controller",
                    dest="maas_controller",
                    type=str,
                    required=True,
                    help="maas-controller name")
parser.add_argument("--maas-model",
                    dest="maas_model",
                    type=str,
                    required=True,
                    help="maas model name")
...
class NodePool(object):
	...
	print "maas contr", options.maas_controller
	print "maas model", options.maas_model
        self.juju = environment.Environment.connect(options.maas_controller + ':' + options.maas_model)
